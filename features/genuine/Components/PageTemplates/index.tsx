...
import { DrawerIndex, GenuineState } from '@/features/genuine/types'
import { Setters } from '../Setters'
import { SurfaceDrawers } from '@/Components/Drawers'
import { Position } from '@/types'
import { models } from '@/features/genuine/Constants/model'
...
export const GenuinePageTemplates: FC<Props> = ({ state, position, theme, rearSurfaceId, palmSurfaceId, dispatch }) => {
