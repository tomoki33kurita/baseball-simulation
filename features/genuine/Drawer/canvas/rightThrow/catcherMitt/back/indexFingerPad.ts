...
export const indexFingerPadWithNoEdge = (ctx: CanvasRenderingContext2D, leatherColor: string, stitchColor: string): void => {
  ...
  ctx.fillStyle = leatherColor
  ctx.beginPath()
  ctx.moveTo(316, 436) // 左下
  ctx.quadraticCurveTo(326, 450, 350, 460) // 中央下＿左
  ctx.quadraticCurveTo(377, 464, 400, 457) // 中央下＿右
  ctx.quadraticCurveTo(414, 446, 417, 430) // 右下
  ctx.quadraticCurveTo(390, 315, 390, 315) // 右上
  ctx.quadraticCurveTo(378, 267, 326, 273) // 中央上
  ctx.quadraticCurveTo(291, 283, 292, 321) // 左上
  ctx.quadraticCurveTo(316, 435, 316, 435) // 左下
  ctx.fill()
  ctx.stroke()
  ctx.closePath()
  ...
  // ヘリ革接合部分
  ctx.moveTo(322, 436) // 左下
  ctx.quadraticCurveTo(367, 420, 412, 428) //
