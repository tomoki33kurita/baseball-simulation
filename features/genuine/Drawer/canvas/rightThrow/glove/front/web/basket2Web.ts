...
export const basket2Web = (
  ...
  // 1段目
  checkCellParts(ctx, webColorFirst, 0, 0, 0)
  checkCellParts(ctx, webColorFirst, -52, 59, -5)
  checkCellParts(ctx, webColorFirst, -100, 113, -8)
  // 2段目
  checkCellParts(ctx, webColorFirst, -12, 38, 0)
  checkCellParts(ctx, webColorFirst, -64, 100, -5)
  // 3段目
  checkCellParts(ctx, webColorFirst, 14, 39, 0)
  checkCellParts(ctx, webColorFirst, -39, 100, -5)
  checkCellParts(ctx, webColorFirst, -88, 150, -8)
  // 4段目
  checkCellParts(ctx, webColorFirst, -17, 103, -5)
  checkCellParts(ctx, webColorFirst, -50, 140, -5)
  // 5段目
  checkCellParts(ctx, webColorFirst, 5, 105, -4)
  checkCellParts(ctx, webColorFirst, -45, 158, -8)
  checkCellParts(ctx, webColorFirst, -75, 189, -8)
  ...
  // stitchここまで
  // ウェブ先端
  topSidePartOfWebWithJoint2(ctx, webColorFirst, webColorSecond, laceColor, stitchColor)
}
