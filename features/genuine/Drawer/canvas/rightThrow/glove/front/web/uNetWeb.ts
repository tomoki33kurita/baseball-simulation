...
export const uNetWeb = (ctx: CanvasRenderingContext2D, state: GenuineState): void => {
  ...
  ctx.quadraticCurveTo(349, 278, 336, 291) // 中央＿右下
  ctx.quadraticCurveTo(293, 159, 292, 157) // 中央＿右上
  ctx.quadraticCurveTo(271, 179, 257, 202) // 中央＿左上
  ctx.quadraticCurveTo(317, 316, 317, 316) // 中央＿左下
  ctx.quadraticCurveTo(310, 332, 297, 338) // 左下＿内側
  ...
  ctx.quadraticCurveTo(261, 303, 296, 341) // 左下

  ctx.quadraticCurveTo(313, 334, 319, 316) // 右下
  ctx.quadraticCurveTo(260, 201, 260, 201) // 右上
  // 右窓周辺
  ctx.moveTo(290, 162) // 左上
  ctx.quadraticCurveTo(334, 294, 335, 296) // 左下
  ctx.quadraticCurveTo(351, 282, 357, 257) // 右下
  ctx.quadraticCurveTo(348, 184, 331, 125) // 右上
  // 中央＿縦ライン
  ctx.moveTo(271, 184) // 左上
  ctx.quadraticCurveTo(324, 305, 324, 305) // 左下
  ctx.quadraticCurveTo(328, 303, 328, 303) // 右下
  ...
  // ウェブ先端
  topSidePartOfWeb(ctx, web2Color || webColor, laceColor, stitchColor)
  //
}
